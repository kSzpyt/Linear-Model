...
bootstrap <- function(dane, alpha = 0.05, n = N)
{
...
Hipoteza potwierdziła się, zwiększająca się liczba koni mechanicznych zwiększa spalanie w przybliżeniu o 0.03 $\frac{l}{100km}$, a wzrost wagi (kg) implikuje wzrost spalanie o około 0.006 $\frac{l}{100km}$
